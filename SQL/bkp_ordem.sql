...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Abr-2020 às 19:36
...
(2, 1, '2020-04-08', NULL, '1,000.00', 0, '', '2020-03-31 06:45:16'),
...
(6, 3, '2020-04-30', '2020-04-04 02:49:47', '5,000.00', 1, '', '2020-04-04 05:49:47');
...
(1, '::1', 'admin@admin.com.br', 1585983022);
...
(3, '41697502', NULL, 3, 3, 1, 'Mouse usb', 'UN', '9,99', '15,22', '2', '2', 1, '', '2020-04-03 06:59:37');
...
(1, '127.0.0.1', 'administrator', '$2y$12$/K3QCw2uqSlYxvkh1g3lzeA2P6S4aye105JYlv/Qz3.iXHRCxF4fy', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1585983030, 1, 'Admin', 'istrator', 'ADMIN', '0'),
(4, '::1', 'lucio', '$2y$10$UIXAFjSvH4xD168EJcjvlO2RNtKRTU8sTIHujYD72QLKeZQ91FUJe', 'lucio@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1585987854, 1585987889, 1, 'Lucio', 'Souza', NULL, NULL);
...
--
ALTER TABLE `venda_produtos`
  MODIFY `id_venda_produtos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
